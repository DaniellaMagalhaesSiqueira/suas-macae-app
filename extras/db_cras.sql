CREATE DATABASE IF NOT EXISTS suas_macae;
...
-- VALUES (1, "admin", NULL, NULL, NULL, "daniella.siqueira80@gmail.com", MD5("senha"), NULL, "G", NULL, NULL,
--     NULL, NULL);

UPDATE funcionarios set senha_funcionario = MD5("senha") WHERE id_funcionario = 1
