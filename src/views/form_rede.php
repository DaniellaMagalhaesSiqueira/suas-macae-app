...
<form action="#" method="post">
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control  <?= $errors['nome_rede']?'is-invalid':''?>" name="nome_rede" value="<?= $nome_rede ?>">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control  <?= $errors['logradouro_rede']?'is-invalid':''?>" name="logradouro_rede"
        ...
        <div class="form-group col-md-1">
            ...
            <input type="number" class="form-control" name="num_endereco_rede"
                value="<?= $num_endereco_rede ?>">
        </div>
        <div class="form-group col-md-4">
            <label for="ponto_referencia_rede">Ponto de Referência</label>
            <input type="text" class="form-control" name="ponto_referencia_rede"
    ...
    <div class="form-row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="bairro_rede" value="<?= $bairro_rede ?>">
        </div>
        <div class="form-group col-md-3">
            <label for="email_rede">E-mail</label>
            <input type="email" class="form-control  <?= $errors['email_rede']?'is-invalid':''?>" name="email_rede"
                 value="<?= $email_rede ?>">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control  <?= $errors['tel1_rede']?'is-invalid':''?>" name="tel1_rede" 
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="tel2_rede" onkeypress="$(this).mask('(00)00000-0000');"
                value="<?= $tel2_rede ?>">
        </div>
        <div class="form-group col-md-2">
            <input type="checkbox" name="ativo_rede" class="mt-5 ml-4" <?= $ativo_rede == 1 ?'checked':'' ?>>
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input type="text" name="contato_rede" id="" value="<?= $contato_rede ?>" class="form-control">
        </div>
        <div class="form-group col-md-2">
            <label for="contato_rede">Cargo do Contato</label>
            <input type="text" name="contato_rede" placeholder="Ex.Coordenador" value="<?= $contato_rede ?>" class="form-control">
        </div>
        <div class="form-group col-md-2">
            <label for="horario_funcionamento_rede">Funcionamento</label>
            <input type="text" name="horario_funcionamento_rede" class="form-control"
                placeholder="Ex.de 8 as 17 hs" value="<?= $horario_funcionamento_rede ?>">
        </div>
        <div class="form-group col-md-3">
            <label for="contato_rede">Público</label>
            <select name="publico_rede" id="publico_rede" class="form-control <?= $errors['publico_rede']?'is-invalid':''?>">
                <optgroup>
        ...
        <div class="form-group col-md-2">
            ...
            <select name="natureza_rede" id="natureza_rede" class="form-control <?= $errors['natureza_rede']?'is-invalid':''?>">
                <optgroup>
                    <option value="null" selected disabled>Natureza</option>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <select name="setor_rede" id="setor_rede" class="form-control <?= $errors['setor_rede']?'is-invalid':''?>">
                <optgroup>
        ...
        <div class="form-group col-md-8">
            ...
            <textarea type="text" name="descricao_rede" class="form-control" placeholder="Descreva os serviços oferecidos, condições para ingresso e forma de encaminhamentos"><?= $descricao_rede ?></textarea>
        </div>
    </div>
